...
public class AuditConfigMigrater {
    ...
    public static void main(String[] args) {
        ...
        options.addOption(Option.builder("oad").argName("output-audit-dir").hasArg().desc("Output directory to store the generated " + AUDIT_YML + " file. To be uploaded in the index, the file must be present in plugins/"+OpenDistroSecurityPlugin.PLUGIN_NAME
                +"/securityconfig/ or use securityadmin tool.").build());
